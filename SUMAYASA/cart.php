...
?>
    <script type="text/javascript">
        alert("Pesanan Telah Dibuat, Silahkan Sediakan Uang Tunai Untuk Membayar");
    </script>
<?php
}
...
<head>
    ...
    <style>
        ...
        .panel {
            border: 1px solid #996B4D;
            padding-left: 0px;
            padding-right: 0px;
        }

        .panel-heading {
            background: #996B4D !important;
	              ...
	              <button type="button" id="register_button" class="btn btn-lg" data-toggle="modal" data-target="#register">Sign Up</button>
	                <div id="register" class="modal fade" role="dialog">
	                  <div class="modal-dialog">
                        ...
                        echo ' <li> <a href="destroy.php" class="btn btn-lg"> Log Out </a> </li>';
                    ?>
    ...
    <div id="top">
      ...
      <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#996B4D;text-transform:uppercase;">  YOUR CART </h2>
           </div>
        </div>';
        if (isset($_SESSION['user'])) {
            if (isset($_GET['ID'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($j % 2 == 0)
                        echo '<div class="row">';
                    echo '                
                                      <div class="panel col-xs-12 col-sm-4 col-sm-offset-' . $offset . ' col-md-4 col-md-offset-' . $offset . ' col-lg-4 col-lg-offset-' . $offset . ' text-center" style="color:#996B4D;font-weight:800;">
                                          ...
                                          <div class="panel-body">
			                                                <img class="image-responsive block-center" src="' . $path . '" style="height :100px;"> <br>
                                                                       ...
                                                                       <a href="cart.php?remove=' . $row['PID'] . '" class="btn btn-sm" 
                                                                          style="background:#996B4D;color:white;font-weight:800;">
                                                                          Remove
                                                                        </a>
                                        </div>
                                    </div>';
                ...
                echo '<div class="container">
                              <div class="row">  
                                 <div class="panel col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4 text-center" style="color:#996B4D;font-weight:800;">
                ...
                echo '<div class="row">
                             <div class="col-xs-8 col-xs-offset-2  col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-3 col-lg-4 col-lg-offset-3">
                                  <a href="index.php" class="btn btn-lg" style="background:#996B4D;color:white;font-weight:800;">Continue Shopping</a>
                             </div>
                             <div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-1 col-lg-4 ">
                                  <a href="cart.php?place=true" class="btn btn-lg" style="background:#996B4D;color:white;font-weight:800;margin-top:5px;">Place Order</a>
                             </div>
                           </div>
                           ';
            } else {
                echo ' 
                         <div class="row">
                            <div class="col-xs-9 col-xs-offset-3 col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5">
                                 <span class="text-center" style="color:#996B4D;font-weight:bold;">&nbsp &nbsp &nbsp &nbspCart Is Empty</span>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-xs-9 col-xs-offset-3 col-sm-2 col-sm-offset-5 col-md-2 col-md-offset-5">
                                  <a href="index.php" class="btn btn-lg" style="background:#996B4D;color:#F3EAD1;font-weight:800;">Do Some Shopping</a>
                             </div>
                          </div>';
            }
        } else {
