  ...
  <div class="container-fluid" id="books">
    <div class="row">
      <div class="col-sm-10 col-md-6">
                         ...
                         <img class="book center-block img-responsive" src="' . $path . '" style="padding:20px;">
      </div>
      ...
      echo '                           <br><br><br>
                                <a id="buyLink" href="' . $target . '" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;"> 
                                    ADD TO CART for Rp ' . $row["Price"] . ' <br>
                                    <span style="text-decoration:line-through;"> Rp ' . $row["MRP"] . '</span> 
